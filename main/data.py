...
if __name__ == "__main__":
    ds = SupervisedSLAKHDataset(sr=22050,
                                channels=1,
                                min_duration=10.1,
                                max_duration=600.0,
                                aug_shift=True,
                                sample_length=220500,
                                audio_files_dir='/home/emilian/DataspellProjects/audio-diffusion-pytorch-trainer/data/SLAKH2000_super/train',
                                stems=['bass', 'drums', 'piano', 'guitar'])
    print(ds[0].shape)
